...
def test_post_order_add(client, firstname, lastname, street_address_1, city, country_code, area_code, email, telephone, product_id, quantity, payment_method, shipping_method):
